...
// 		set<int> *freq_corv_members = new set<int>;
// 		for (auto&elem: *corv_members)
// 		{
// 			if (frequent_vertices[elem])
// 			{
// 				freq_corv_members->insert(elem);
// 			}
// 		}
// 		delete corv_members;
// 		corv.push_back(freq_corv_members);
// 		total_corv_size += freq_corv_members->size();
// 	}
...
replica_s *get_replica_brute(subgraph_pattern &q, int extending_index, int extended_label, int edge_label)
{
	...
	cout << "Replica call: extending index| extended label| edge label::" << extending_index << " " << extended_label << " " << edge_label << "\n";
